...
<div class="wrap <?= $themes[$tm]['wrap'] ?>">
    <div class="content content-without-title">
        <div class="block">
            <p>
                <?= $translate[$lang]['signup']['signip_end_message'] ?>
            </p>
            <button class="button <?= $themes[$tm]['button-fill'] ?> button-s button-submit-signup_end " id="send_to_home"><?= $translate[$lang]['signup']['signin'] ?></button>
        </div>
    </div>
</div>
